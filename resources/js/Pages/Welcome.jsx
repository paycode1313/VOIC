...
export default function Welcome({ recentSessions = [] }) {
    ...
    return (
        <AppLayout currentRoute="home" activeTab={activeTab} onTabChange={handleTabChange}>
            ...
            <div className="absolute top-0 right-1/4 w-[600px] h-[350px] bg-emerald-500/5 dark:bg-emerald-500/5 rounded-full blur-3xl pointer-events-none" />
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 relative z-10">
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center gap-2.5">
                                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[11px] text-slate-700 dark:text-slate-300">
                                    <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
                                    <span>COMMAND CENTER VOIC</span>
                                </span>
                            ...
                            <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 max-w-2xl leading-relaxed">
                                Bilik latihan vokal otonom terintegrasi. Beralih antar fitur Panggilan AI, Chat Gemini, Studio Mandiri, dan Riwayat Sesi dengan mudah melalui menu navigasi di bilah samping (sidebar).
                            </p>
                        </div>
                        ...
                        <div className="flex flex-wrap items-center gap-2.5 shrink-0">
                            {/* Gemini Status Badge */}
                            <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-purple-50 dark:bg-purple-950/40 border border-purple-200/80 dark:border-purple-800/40 font-mono text-xs text-purple-700 dark:text-purple-300 shadow-2xs transition-colors">
                            ...
                            <button
                                ...
                                className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-white hover:bg-rose-50/60 dark:bg-[#141822] dark:hover:bg-rose-950/30 border border-slate-200/80 dark:border-white/[0.1] text-xs font-medium text-slate-700 dark:text-slate-200 transition-colors cursor-pointer"
                            ...
                            >
                                <Microphone size={15} className={isTestingMic ? 'text-sky-600 animate-pulse' : 'text-slate-500'} />
                ...
                <section className="space-y-6">
                    ...
                    {activeTab === 'calls' && (
                        ...
                        >
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                ...
                                <div className="text-[11px] font-mono text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/40 px-3 py-1.5 rounded-xl border border-emerald-500/30 flex items-center gap-2 shrink-0">
                                    <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                {personas.map((p) => (
                                    <div
                                        key={p.id}
                                        className="bg-white dark:bg-[#0f1219] hover:bg-slate-50 dark:hover:bg-[#121622] border border-slate-200 dark:border-white/[0.08] hover:border-emerald-500/40 rounded-2xl p-6 transition-all duration-200 shadow-md dark:shadow-xl flex flex-col justify-between space-y-5 group"
                                    >
                                        <div className="space-y-3.5">
                                            {/* Card Top: Avatar, Names & Badge */}
                                            <div className="flex items-start justify-between gap-3">
                                                <div className="flex items-center gap-3">
                                                    <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${p.avatar_color} border border-white/[0.15] text-white font-mono font-bold flex items-center justify-center text-sm shadow-md group-hover:scale-105 transition-transform shrink-0`}>
                                                        {p.avatar}
                                                    </div>
                                                    <div>
                                                ...
                                                <span className="text-[10px] font-mono text-emerald-700 dark:text-emerald-300 bg-emerald-50 dark:bg-emerald-950/60 px-2.5 py-1 rounded-full border border-emerald-500/30 font-semibold shrink-0">
                                                    {p.badge}
                                                </span>
                                            </div>
                                            ...
                                            <div className="p-3 rounded-xl bg-slate-50 dark:bg-[#090b10] border border-slate-200 dark:border-white/[0.05] text-[11px] text-slate-600 dark:text-slate-400 font-sans italic">
                                                "{p.sample_question}"
                                            </div>
                                            ...
                                            <div className="flex flex-wrap gap-1.5 font-mono text-[10px] pt-1">
                                                {p.tags.map((t, idx) => (
                                                    <span key={idx} className="px-2 py-0.5 rounded bg-slate-100 dark:bg-[#141822] border border-slate-200 dark:border-white/[0.06] text-slate-600 dark:text-slate-400">
                                                        {t}
                                                    </span>
                                                ))}
                                            </div>
                                        ...
                                        <div className="pt-3 border-t border-slate-100 dark:border-white/[0.06] flex items-center justify-between gap-2.5">
                                            ...
                                            <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
                                                ...
                                                <Link
                                                    ...
                                                    className="flex-1 sm:flex-none inline-flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-[#181d2a] dark:hover:bg-[#222a3d] border border-slate-200 dark:border-white/[0.08] text-slate-700 dark:text-slate-200 hover:text-slate-900 dark:hover:text-white text-xs font-semibold transition-all active:scale-[0.98]"
                                                ...
                                                <Link
                                                    ...
                                                    className="flex-1 sm:flex-none inline-flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold transition-all active:scale-[0.98] shadow-md shadow-emerald-950/40"
                    ...
                    {activeTab === 'studio' && (
                        ...
                        >
                            ...
                            <div className="bg-white dark:bg-[#0f1219] border border-slate-200 dark:border-white/[0.08] rounded-2xl p-6 shadow-md dark:shadow-xl space-y-4 transition-colors">
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-100 dark:border-white/[0.06] pb-3">
                                    ...
                                    <button
                                        type="button"
                                        onClick={toggleMicTest}
                                        className={`px-3.5 py-1.5 rounded-xl font-mono text-xs font-semibold border transition-all cursor-pointer ${
                                            isTestingMic 
                                                ? 'bg-emerald-50 dark:bg-emerald-950/70 border-emerald-500/50 text-emerald-700 dark:text-emerald-300' 
                                                : 'bg-slate-100 hover:bg-slate-200 dark:bg-[#141822] border-slate-200 dark:border-white/[0.1] text-slate-700 dark:text-slate-300'
                                        }`}
                                    >
                                ...
                                <div className="rounded-xl overflow-hidden border border-slate-200 dark:border-white/[0.08] bg-[#090b10]">
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 font-mono text-xs text-center">
                                    <div className="p-2.5 bg-slate-50 dark:bg-[#141822] rounded-xl border border-slate-200 dark:border-white/[0.04]">
                                    ...
                                    <div className="p-2.5 bg-slate-50 dark:bg-[#141822] rounded-xl border border-slate-200 dark:border-white/[0.04]">
                                        ...
                                        <span className="text-emerald-600 dark:text-emerald-400 font-bold">0 ms</span>
                                    </div>
                                    <div className="p-2.5 bg-slate-50 dark:bg-[#141822] rounded-xl border border-slate-200 dark:border-white/[0.04]">
                                        <span className="text-[9px] text-slate-500 uppercase block">STATUS MIC</span>
                                        <span className={isTestingMic ? 'text-emerald-600 dark:text-emerald-400 font-bold' : 'text-slate-500 font-bold'}>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                                             ...
                                             return (
                                                 <button
                                                     ...
                                                     className={`w-full p-4 rounded-xl text-left border transition-all cursor-pointer relative ${
                                                         isCurrent 
                                                             ? 'bg-emerald-50/70 dark:bg-[#141822] border-emerald-500/50 text-slate-900 dark:text-white' 
                                                             : 'bg-white dark:bg-[#0f1219] border-slate-200 dark:border-white/[0.06] text-slate-600 dark:text-slate-400 hover:border-slate-300 dark:hover:border-white/[0.14]'
                                                     }`}
                                                 >
                                                     <div className="flex items-center justify-between">
                                                         <span className="text-[10px] font-mono font-medium text-emerald-600 dark:text-emerald-400 uppercase">
                                                             {s.tag}
                                                         </span>
                                    ...
                                    <div className="lg:col-span-8 bg-white dark:bg-[#0f1219] border border-slate-200 dark:border-white/[0.08] rounded-2xl p-6 sm:p-7 space-y-6 shadow-md dark:shadow-xl transition-colors">
                                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-100 dark:border-white/[0.06] pb-4">
                                            ...
                                            <div className="flex items-center gap-2 text-xs font-mono text-slate-600 dark:text-slate-400 bg-slate-100 dark:bg-[#141822] px-3 py-1.5 rounded-lg border border-slate-200 dark:border-white/[0.06]">
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                            {current.metrics.map((m, idx) => (
                                                <div key={idx} className="p-3.5 bg-slate-50 dark:bg-[#141822] border border-slate-200 dark:border-white/[0.06] rounded-xl font-mono space-y-1">
                                                    <div className="text-[10px] text-slate-500 uppercase font-medium">{m.label}</div>
                                                    <div className="text-lg font-bold text-emerald-600 dark:text-emerald-400">{m.value}</div>
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-slate-700 dark:text-slate-300">
                                                {current.rubrics.map((r, i) => (
                                                    <div key={i} className="flex items-center gap-2 p-2 rounded-lg bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/[0.04]">
                                                        <div className="w-4 h-4 rounded-full bg-emerald-100 dark:bg-emerald-950/70 border border-emerald-500/40 text-emerald-600 dark:text-emerald-400 flex items-center justify-center shrink-0">
                                        ...
                                        <div className="pt-3 flex items-center justify-between border-t border-slate-100 dark:border-white/[0.06]">
                                            ...
                                            <Link
                                                ...
                                                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold transition-all active:scale-[0.98] shadow-md shadow-emerald-950/40"
                                            >
